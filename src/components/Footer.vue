      ...
      <div class="flex justify-around gap-10 flex-wrap">
        <div class="flex-1">
          ...
          <ul class="mt-4 flex flex-col">
            <li class="mx-auto min-w-max">
              <a href="https://www.facebook.com/phoenixvetements/" class="duration-150 px-4 py-2 mx-auto text-center hover:text-[#2E4B92] group decoration-neutral-700 underline-offset-2 flex gap-3 items-center">
                <svg class="h-5 group-hover:fill-[#2E4B92] duration-150" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            ...
            <li class="mx-auto min-w-max">
              <a href="https://www.linkedin.com/company/phoenix-vetements-et-protection/" class="duration-150 px-4 py-2 mx-auto text-center hover:text-[#2E4B92] group decoration-neutral-700 underline-offset-2 flex gap-3 items-center">
                <svg class="h-4 group-hover:fill-[#2E4B92] duration-150" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
        ...
        <div class="flex-1">
          ...
          <ul class="mt-4 flex flex-col gap-1">
            <li class="mx-auto min-w-max">
              <router-link class="block px-4 py-2 text-center hover:text-[#2E4B92] decoration-neutral-700 underline-offset-2 " to="/legalnotice">Mentions légales</router-link>
            </li>
            <li class="mx-auto min-w-max">
              <router-link class="block px-4 py-2 text-center hover:text-[#2E4B92] decoration-neutral-700 underline-offset-2 " to="/about">A propos</router-link>
            </li>
            <li class="mx-auto min-w-max">
              <router-link class="block px-4 py-2 text-center hover:text-[#2E4B92] decoration-neutral-700 underline-offset-2 " to="/contact">Contact</router-link>
            </li>
          </ul>
        </div>
        <div class="flex-1">
